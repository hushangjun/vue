<template>
    <div id="content">
        <div class="mui-card" v-for="goods in goodslist" key:goods.id>
				<div class="mui-card-header mui-card-media" v-bind="{style:`height:100vw;background-image:url(${goods.img_url});`}"></div>
				<div class="mui-card-content">
					<div class="mui-card-content-inner">
						<p>现价：<strong style="font-size:6vw;color:red">{{goods.sell_price}}</strong>&nbsp;&nbsp;  <del>市场价：{{goods.market_price}}</del></p>
